...
const DB = {
        ...
        "relic_orc_nail":           { n: "惡臭的妖魔指甲",     type: "wpn", relic: true, noEnhance: true, dmgS: 2, dmgL: 3, hit: 9, dmgBonus: 7, procPoison: { rate: 30, dmg: [10, 10], dur: 10, tick: 1 }, req: "royal,knight,elf,mage,dark", p: 10000, gachaWeight: 0, d: "【遺物】妖魔殭屍剝落的惡臭指甲，抓傷處會潰爛流膿。<br>攻擊命中時 30% 機率使目標中毒，每秒受到 10 點固定傷害。" },
        ...
        "relic_elastic_rib":        { n: "有彈性的肋骨",       type: "wpn", relic: true, noEnhance: true, ignHardSkin: true, dmgS: 8, dmgL: 8, hit: 6, dmgBonus: 9, dr: 2, eff: "combo", comboRate: 30, req: "dark", p: 10000, gachaWeight: 0, d: "【遺物】骷髏弓箭手身上抽出的柔韌肋骨，揮舞如刃、格擋如盾。<br>雙擊 30%；傷害減免 +2。" },
        ...
        "relic_spider_claw":        { n: "巨大蜘蛛的恐懼尖爪",  type: "wpn", w2h: true, relic: true, noEnhance: true, dmgS: 17, dmgL: 15, hit: 10, dmgBonus: 9, eff: "combo", comboRate: 30, procPoison: { rate: 50, dmg: [10, 10], dur: 10, tick: 1 }, req: "dark", p: 10000, gachaWeight: 0, d: "【遺物】巨大蜘蛛的恐懼尖爪，撕裂處滲出致命劇毒。<br>攻擊命中時 50% 機率使目標中毒，每秒受到 10 點固定傷害。" },
        ...
        "relic_sparta_grudge":      { n: "史巴托的怨念",       type: "wpn", relic: true, noEnhance: true, ignHardSkin: true, dmgS: 11, dmgL: 7, hit: 11, dmgBonus: 10, eff: "combo", comboRate: 25, req: "dark", p: 10000, gachaWeight: 0, d: "【遺物】史巴托死後凝聚的怨念雙刀，揮舞時透出徹骨恨意。<br>雙擊 25%。" },
        ...
        "relic_venom_fang":         { n: "劇毒的獠牙",         type: "wpn", w2h: true, relic: true, noEnhance: true, dmgS: 17, dmgL: 21, hit: 9, dmgBonus: 12, eff: "cleave", procPoison: { rate: 50, dmg: [30, 30], dur: 10, tick: 1 }, req: "royal,knight,dragon", p: 10000, gachaWeight: 0, d: "【遺物】狂野毒牙淬鍊的巨牙，切開之處毒液奔流不止。<br>切割（一般限定）；攻擊命中時 50% 機率使目標中毒，每秒受到 30 點固定傷害。" },
