...
const GAME_VERSION = 'v3.7.91';   // 🏷️ 版本號：末段 0~99 線性遞增，達 100 進位（中位 +1、末段歸 0）
    ...
    towns: {
        ...
        "town_witon": {
            ...
            npcs: [
                ...
                { id: "npc_doruga_bell", n: "多魯嘉貝爾", title: "副本", type: "dungeon", d: "多魯嘉家族的守望者，世代看守著被侵蝕的龍之巢穴。可由此進入「侵蝕的安塔瑞斯巢穴」（相同模式所有角色合計每日通關 1 次·UTC+8 凌晨重置；副本內禁止傳送與離線掛機），並設定最多 4 位助戰者提供增益。" },   // 🐉 v3.7.62 安塔瑞斯副本入口＋助戰者
